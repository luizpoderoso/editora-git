...
const Item = ({ book, texts }) => {
  ...
  return (
    <li className="md:w-full md:h-[420px] lg:w-[430px] lg:h-[210px] xl:w-[500px] xl:h-[378px] 2xl:w-[700px] 2xl:h-[420px] shadow-lg inline-flex rounded-xl border dark:border-zinc-900">
      ...
      <div className="relative lg:min-w-[280px] lg:min-h-[210px] xl:min-w-[230px] 2xl:min-w-[400px] px-2 lg:px-1 xl:px-3 2xl:px-8 py-4 lg:py-1 xl:py-5 2xl:py-6 rounded-r-xl dark:bg-zinc-900">
